        ...
        <div class="app-content">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-info card-outline mb-4">
                    ...
                    <table id="tabla_roles" class="table table-striped table-hover align-middle w-100" data-ajax="<?php echo e(route('roles.list')); ?>">
                    <thead>
                        <tr>
                        <th></th> 
                        <th>#</th>
...
<div class="modal" id="crearRol" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('users.roles.store' )); ?>" class="needs-validation" id="crearRol" autocomplete="off">                    
                    <?php echo csrf_field(); ?>
                    <!--begin::Body-->
                    <div class="card-body">
                        <div class="row g-2">
...
<?php echo $__env->make('plantilla', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Documentos\LARAVEL\EpsilonV2-VersionControl\2025-08-27-CrearRolesEpsilon-1\Epsilon-1\Epsilon\resources\views/paginas/Sistemas/crear_roles.blade.php ENDPATH**/ ?>