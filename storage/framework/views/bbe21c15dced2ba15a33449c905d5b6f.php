<nav class="app-header navbar navbar-expand bg-body" id="navigation" tabindex="-1">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav" role="navigation" aria-label="Navigation 1">
            ...
            <li class="nav-item d-none d-md-block"><a href="<?php echo e(url('/')); ?>" class="nav-link">Inicio</a></li>
            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-footer">
                  ...
                  <!--a href="<?php echo e(route('logout')); ?>" class="btn btn-default btn-flat float-end">Cerrar sesión</a-->
        ...
        <!--end::Container-->
      </nav><?php /**PATH E:\Documentos\LARAVEL\EpsilonV2-VersionControl\2025-08-27-CrearRolesEpsilon-1\Epsilon-1\Epsilon\resources\views/modulos/header.blade.php ENDPATH**/ ?>